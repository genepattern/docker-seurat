...
# build using this:
# docker build -t edjuaro/docker-seurat:1.2 .

# run using this:
# docker run --rm -t -p 8888:8888 -e GRANT_SUDO=yes edjuaro/docker-seurat:1.2
# or with
# docker run -it edjuaro/docker-seurat:1.2 bash
